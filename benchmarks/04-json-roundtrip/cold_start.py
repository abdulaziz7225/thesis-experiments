"""
Cold-start and warm-start measurement for 04-json-roundtrip.
...
Sequential execution model:
  ...
  is torn down and 04-json-roundtrip is deployed.
...
Output files (results/04-json-roundtrip/):
...
DEPLOYMENT_NAMES: dict[str, str] = {
    "wasm-rust":     "json-roundtrip-wasm-rust",
    "wasm-tinygo":   "json-roundtrip-wasm-tinygo",
    "docker-rust":   "json-roundtrip-docker-rust",
    "docker-golang": "json-roundtrip-docker-golang",
}
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Cold/warm-start benchmark (04-json-roundtrip)")
    ...
    if cold_results:
        ...
        print("\nCold-start results → results/04-json-roundtrip/cold_start.json")

    if warm_results:
        save_json(warm_results, "warm_start.json", subdir=RESULTS_SUBDIR)
        print("Warm-start results → results/04-json-roundtrip/warm_start.json")
