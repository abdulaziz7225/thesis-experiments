...
Output: results/04-json-roundtrip/resource_metrics.json
"""
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Prometheus resource metrics (04-json-roundtrip)")
