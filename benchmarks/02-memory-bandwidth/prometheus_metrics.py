"""
Collect resource metrics from Prometheus for a single variant during the 02-memory-bandwidth experiment.
...
Output: results/02-memory-bandwidth/resource_metrics.json
"""
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Prometheus resource metrics (02-memory-bandwidth)")
